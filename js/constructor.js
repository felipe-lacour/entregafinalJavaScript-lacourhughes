...
const wakandafe = new Pelicula('Black Panther: Wakanda Forever', 6.99, 2022, nl, 6)
...
const ted = new Pelicula('Ted', 2.99, 2012, cls, 7)

peliculas.push(avatar2, eeaao, pussInBoots, theMenu, spiderman3, theGodfather, greenMile, topGun, forrestGump, invincible, rocky, wakandafe, ted)
